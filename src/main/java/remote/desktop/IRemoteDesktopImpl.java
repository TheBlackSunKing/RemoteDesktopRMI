...
public class IRemoteDesktopImpl extends UnicastRemoteObject implements IRemoteDesktop {
    public final static int GB = 1024 * 1024 * 1024;

    private Robot mr_robot;
    private OperatingSystemMXBean os;

    public IRemoteDesktopImpl() throws RemoteException, AWTException {
        super();
    ...
    public long[] getRamMemories() throws RemoteException {
        return new long[] {
            1 + this.os.getTotalMemorySize() / IRemoteDesktopImpl.GB,
            1 + this.os.getTotalSwapSpaceSize() / IRemoteDesktopImpl.GB
        };
    }
